...
(function () {
    ...
    SettingsController.$inject = ['$scope', '$timeout', '$mdSidenav', '$log', '$interval', '$sce', '$mdDialog', '$mdMedia', 'Icecast', 'Track'];

    /* @ngInject */
    function SettingsController($scope, $timeout, $mdSidenav, $log, $interval, $sce, $mdDialog, $mdMedia, Icecast, Track) {
